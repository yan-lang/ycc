...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ycc/flexsearch.min.js');loadScript('/ycc/cn.search-data.min.0c52be49f07f212f7962fb5cf84b2a01c864aefe9157878c9770acaec4d7cb79.js',function(){input.required=false;search();});}
