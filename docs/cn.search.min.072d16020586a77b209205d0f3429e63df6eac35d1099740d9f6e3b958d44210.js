...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ycc/flexsearch.min.js');loadScript('/ycc/cn.search-data.min.42deb99633bcf810b6ba7e6d50731b6e61a784fb0452d9e6b7a5805250062ca1.js',function(){input.required=false;search();});}
