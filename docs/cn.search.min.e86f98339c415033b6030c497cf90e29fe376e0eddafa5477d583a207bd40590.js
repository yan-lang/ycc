...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ycc/flexsearch.min.js');loadScript('/ycc/cn.search-data.min.0d048d96801d230a1dd9bab0f559f27c12d04853b3b5949656d2495976978d4f.js',function(){input.required=false;search();});}
