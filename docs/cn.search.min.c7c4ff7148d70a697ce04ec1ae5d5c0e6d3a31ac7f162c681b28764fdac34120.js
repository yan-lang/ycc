...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ycc/docs/flexsearch.min.js');loadScript('/ycc/docs/cn.search-data.min.28baf8143b73ef0a6c9d9263181b27133ec91b64ce761f77c8d956625e4b5bef.js',function(){input.required=false;search();});}
