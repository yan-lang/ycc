...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/ycc/flexsearch.min.js');loadScript('/ycc/cn.search-data.min.e4ada541cef5943e3cfb5a51a45e2e6e3028a448c29d5066a2872b8781e882be.js',function(){input.required=false;search();});}
