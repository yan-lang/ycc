...
public class TypeTreeFormatter implements Formatter<YCTree.TranslationUnit>, YCTree.VoidVisitor {
    private boolean verbose;
    private XMLPrinter printer = new XMLPrinter();

    public TypeTreeFormatter(boolean verbose) {
    ...
    private <T extends Tree> void print(T node, TypeTreeFormatter.DetailPrinter detailPrinter) {
    ...
    private void printField(String name, TypeTreeFormatter.DetailPrinter detailPrinter) {
